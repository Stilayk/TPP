...
\restrict Tzt9dPy52U7I862NqOUmJXfgmkaDsqAetqnn6Q1Zlq1rEvgsxWyZgti9NEm6p5m
...
CREATE TABLE public.admin_role_audit (
    ...
    CONSTRAINT ck_admin_role_audit_action CHECK (((action)::text = ANY (ARRAY[('grant'::character varying)::text, ('revoke'::character varying)::text])))
);
...
CREATE TABLE public.daily_reports (
    ...
    CONSTRAINT ck_daily_report_status CHECK (((status)::text = ANY (ARRAY[('draft'::character varying)::text, ('final'::character varying)::text])))
);
...
--
-- Name: duty_notification_settings; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.duty_notification_settings (
    id integer NOT NULL,
    selected_method character varying(8) DEFAULT 'cron'::character varying NOT NULL,
    cron_enabled_upcoming_5m boolean DEFAULT true NOT NULL,
    cron_enabled_start boolean DEFAULT true NOT NULL,
    cron_enabled_chat_on_start boolean DEFAULT true NOT NULL,
    n8n_enabled_upcoming_5m boolean DEFAULT true NOT NULL,
    n8n_enabled_start boolean DEFAULT true NOT NULL,
    n8n_enabled_chat_on_start boolean DEFAULT true NOT NULL,
    CONSTRAINT ck_duty_notification_settings_method CHECK (((selected_method)::text = ANY ((ARRAY['cron'::character varying, 'n8n'::character varying])::text[]))),
    CONSTRAINT ck_duty_notification_settings_singleton CHECK ((id = 1))
);


ALTER TABLE public.duty_notification_settings OWNER TO app;

--
-- Name: duty_notification_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

CREATE SEQUENCE public.duty_notification_settings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.duty_notification_settings_id_seq OWNER TO app;

--
-- Name: duty_notification_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: app
--

ALTER SEQUENCE public.duty_notification_settings_id_seq OWNED BY public.duty_notification_settings.id;
...
CREATE TABLE public.duty_swap_requests (
    ...
    CONSTRAINT ck_swap_status CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('accepted'::character varying)::text, ('rejected'::character varying)::text]))),
...
--
-- Name: duty_notification_settings id; Type: DEFAULT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.duty_notification_settings ALTER COLUMN id SET DEFAULT nextval('public.duty_notification_settings_id_seq'::regclass);
...
29	2	4	grant	2026-04-15 12:09:13.079089
30	2	4	revoke	2026-04-15 12:23:51.906975
31	2	4	grant	2026-04-15 12:23:53.92222
\.
...
29	2026-04-13	1	draft	\N
30	2026-04-14	1	draft	\N
31	2026-04-14	4	draft	\N
32	2026-04-14	9	draft	\N
33	2026-04-15	1	draft	\N
34	2026-04-15	9	draft	\N
35	2026-04-15	10	draft	\N
36	2026-04-15	3	draft	\N
37	2026-04-15	4	draft	\N
38	2026-04-15	2	final	2026-04-15 08:51:57.198408
39	2026-04-15	5	draft	\N
40	2026-04-16	3	draft	\N
41	2026-04-16	2	draft	\N
42	2026-04-16	5	draft	\N
43	2026-04-16	9	draft	\N
\.
...
--
-- Data for Name: duty_notification_settings; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.duty_notification_settings (id, selected_method, cron_enabled_upcoming_5m, cron_enabled_start, cron_enabled_chat_on_start, n8n_enabled_upcoming_5m, n8n_enabled_start, n8n_enabled_chat_on_start) FROM stdin;
1	n8n	t	t	t	t	t	t
\.
...
161	38	120	Перевезли рабочие места.	Переезд
162	38	20	Переключили сканеры после инвентаризации	Переключение сканеров
163	38	180	Добавление отправки сообщений через rest api вебхука	Работа над сайтом
164	38	10	Выдача доступа по задаче	Выдача доступа
165	38	60	Не работал выданный доступ Данилову Илье в ЕКИСУФ, вместе с 1с-ками разбирались с проблемой	Помощь с восстановлением работы 1с ЕКИСУФ
166	38	60	Дежурство на линии	Дежурство
\.
...
COPY public.users (id, username, full_name, role, password_hash, is_active_for_duties, bitrix_user_id) FROM stdin;
1	admin	Владимир Дерябов	admin	$2b$12$80uN3ZL.q8x3ljNzTNp/zOojBAZo8me8G/Pk2QwsMHuwz2chsDolW	t	\N
3	a.agudalin	Агудалин Александр Ильич	admin	$2b$12$e742NyHIXTY9nLTPx/V5YO3W0SITsTN95K.Hz4/Rsl/.O1vUBjYca	t	6188
2	v.ivanov	Иванов Владимир Алексеевич	admin	$2b$12$ZA651O8uaZS07XE0lq3L4.syPsdFfk.QhiHAjofHOMmpaVfbcQJzK	t	11751
13	i.frolov	Фролов Игорь Вадимович	support	$2b$12$1ypMjsaVnskoZHuXrRyzpeEVA4gvFIC8NrwVAMz5oQN4QJ8SnLcse	t	6837
11	evgeniy.kokoulin	Кокоулин Евгений Николаевич	support	$2b$12$XKLEq9dxvH1yrOM1mP3eDu/B10HpunLOx0zgJu5rYmpDFv9jn1O92	t	69
12	evgeniy.chistyakov	Чистяков Евгений Александрович	support	$2b$12$mr6vWhlROnXJjZtfD5J9AOaOO/O54LZ4tHPXuofs8oifsN9Bv9knS	t	5077
10	ilya.sadriev	Садриев Илья Павлович	support	$2b$12$WFWyrtxp.ABZZzbcNrLRXuXw.W2.aGRUV3XW2Bi8sDyO9qSchUbci	t	4939
9	a.kashanin	Кашанин Александр Андреевич	support	$2b$12$eAkb58H0.Txixqf0lUttbunSlD75BPVL2UkTcoxV4CsCh9Vybnyu6	t	5849
7	danil.knutov	Кнутов Данил Евгеньевич	support	$2b$12$1I1m6an02wRgwxxLcEbbBuXK.WPp1f1dYArmzA0Gy6elr9i1nHMGe	t	17526
6	a.lebedev	Лебедев Андрей Евгеньевич	support	$2b$12$.4UTocNzQ0RRJs7DlBhId.wialdz3c7uWTPgRPGXZl2A3m/iEE0e2	t	5302
4	S.Revin	Ревин Сергей Александрович	admin	$2b$12$ZKX6VUih1FXxfFTsC5qdEOU/3O3LghX.ae0TmyBtADa63JL61dkAm	t	13213
5	user	Все	support	$2b$12$bKR8jjiZiBvHCDzQWDAbWu2JNSz3rpXXBt7Cqn9I5nFLdGKvQt98C	t	441509
\.
...
SELECT pg_catalog.setval('public.admin_role_audit_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.daily_reports_id_seq', 43, true);


--
-- Name: duty_notification_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.duty_notification_settings_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.report_entries_id_seq', 166, true);
...
--
-- Name: duty_notification_settings duty_notification_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.duty_notification_settings
    ADD CONSTRAINT duty_notification_settings_pkey PRIMARY KEY (id);
...
\unrestrict Tzt9dPy52U7I862NqOUmJXfgmkaDsqAetqnn6Q1Zlq1rEvgsxWyZgti9NEm6p5m
